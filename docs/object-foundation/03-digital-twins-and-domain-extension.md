...
Для цифрового двойника [инструкция, применение и выполнение](05-instructions-and-execution.md) особенно важны: конструкция насоса, программа его испытания, место проверки в заказе и фактический протокол не являются одним предметом. Новая программа не переписывает испытания изготовленного экземпляра.

[Адресуемые элементы](04-elements-and-concepts.md) помогают связать эти данные, но не собирают полный двойник автоматически. Нужно сохранить точные основания, происхождение и необходимые измерения. [Понятия](06-domain-concepts.md) могут согласовать терминологию разных источников, однако совпадение названий не доказывает тождество физических экземпляров и не заменяет проверку внешнего соответствия.
