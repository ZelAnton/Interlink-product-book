...
Далее: [инструкции, применения и выполнение](05-instructions-and-execution.md), [предметные понятия](06-domain-concepts.md), [общий фундамент](README.md).

## Основания

Принятое решение и границы: [IL-ELEMENTS §§1–4, 7–8]. Проекция адресов, частей и истории: [IL-ELEMENTS-DATA]. Последовательность подтверждения: [IL-PLAN-EL]. Источники расшифрованы в [реестре](../knowledge/15-source-register.md).
