...
Далее: [элементы и адресация](04-elements-and-concepts.md), [понятия и классификация](06-domain-concepts.md), [маршруты и нормы заказа](../orders/07-routes-norms-and-sourcing.md), [прослеживаемость агентов](../agents/01-agents-and-traceability.md).

## Основания

Разделение ролей и правила исполнения: [IL-ELEMENTS §§2, 6–8]. Данные и точные основания: [IL-ELEMENTS-DATA]. Малые проверки и дальнейшее развитие: [IL-PLAN-EL]. Адреса источников — в [реестре](../knowledge/15-source-register.md).
