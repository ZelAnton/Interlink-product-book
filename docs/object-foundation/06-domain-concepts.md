...
Далее: [общий адрес элемента](04-elements-and-concepts.md), [применение инструкций](05-instructions-and-execution.md), [допустимые замены](../substitution-and-compatibility/01-allowed-replacements.md).

## Основания

Словарь, классификация, роли привязок и исторический смысл: [IL-ELEMENTS §5]. Проекция и план: [IL-ELEMENTS-DATA], [IL-PLAN-EL]. Адреса источников — в [реестре](../knowledge/15-source-register.md).
