...
Когда таблица используется как основание расчёта или выпуска, отдельно фиксируется необходимое точное содержание. Изменение оси или добавление значения не расширяет старую редакцию задним числом. Подробнее — [табличные данные](../tabular-data/README.md).
...
Границы владения, сохранение истории и совместимость расширений проверяются до зависимых прикладных механизмов. При этом полный административный интерфейс и все удобства настройки могут поставляться последовательно. Ранняя проверка фундамента не означает готовый конфигуратор.
...
Актуальные уточнения архитектуры: [IL-STORAGE], [IL-FOUNDATION], [IL-NEUTRAL], [IL-TD], [IL-DATA-MODEL], [IL-PLAN-V2]. При расхождении с ранними описаниями действуют пересмотренные специализированные договоры. Состояние реализации относится к срезу документации от 6 сентября 2026 года.

Исходные предметные и исследовательские основания: [IL-META §5–§7], [IL-DSL §2, §8–§11], [IL-MIG §6–§7], [IL-ADR ADR-016, ADR-026–027, ADR-043, ADR-053], [IPS-A44], [IL-PRECEDENTS]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
