...
flowchart TD
    ...
    B["Разрешённые настройки<br/>подписи, списки, стадии"] --> D
    C["Типизированные расширения<br/>во время эксплуатации"] --> D
    C --> E["Экспорт патча"]
...
- [DSL и модули](03-dsl-product-language.md)
- [Материализация в БД](04-physical-database-materialization.md)
- [Выполнение миграций](09-migration-execution-and-proof.md)

Основания: [IL-META §5–§7], [IL-DSL §2, §8–§11], [IL-MIG §6–§7], [IL-ADR ADR-016, ADR-026–027, ADR-043, ADR-053], [IPS-A44], [IL-PRECEDENTS]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
