...
- [DSL и версии модели](03-dsl-product-language.md)
- [Статусы и риски](13-status-risks-and-acceptance.md)

Основания: [IL-MIG §1–§11], [IL-DB §7–§9], [IL-POC §6–§8], [IL-VERS-IPS], [IPS-A04], [IPS-DB01]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
