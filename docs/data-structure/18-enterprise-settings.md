...
[Предметные понятия](../object-foundation/06-domain-concepts.md) развивают управляемую классификацию, а не создают второй несвязанный каталог. Одно понятие может занимать несколько мест в разных схемах; навигационная папка не обязана обозначать самостоятельный смысл.
