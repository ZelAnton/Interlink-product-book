...
Эксплуатационный двойник с массовой телеметрией рассматривается как возможное дальнейшее развитие, но отдельный трек пока не открыт. Процессный двойник Alvatune является целевым направлением: в будущем он должен опираться на версионируемые определения процессов, происхождение агентских действий и точные контексты. Готового эксплуатационного контура Alvatune с такой связью сейчас нет.
...
- [Исследование платформы цифровых двойников](../../../analysis/opportunities/digital-twin-platform.md)
- [Экземпляры и партии в заказах](../orders/09-units-lots-and-as-built.md)
- [Производительность и агенты](06-performance-and-agent-load.md)

Основания: [IL-ADR ADR-050–052], [IL-META §2.3, §8б], [IL-HOST §1–§3], [ALV-ADR068], [ALV-ADR070], [ALV-AGENT]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
