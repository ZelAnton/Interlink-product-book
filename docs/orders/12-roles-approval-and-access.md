...
- [Доставка модели и границы принимающей системы](../knowledge/08-model-delivery-and-extensibility.md)

Основания: [IPS-A13], [IPS-M03], [IL-HOST §8], [IL-ADR ADR-052]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
