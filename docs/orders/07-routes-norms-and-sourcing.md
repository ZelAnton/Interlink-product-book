...
## Инструкция, переход маршрута и выполнение заказа

Принято [различать повторно используемую инструкцию, её применение и фактическую работу](../object-foundation/05-instructions-and-execution.md). В операции точения вала два перехода могут пользоваться одной инструкцией, но иметь разные поверхности, размеры и нормы. Они не сливаются по совпадению инструкции; перестановка сохраняет их устойчивые адреса внутри маршрута.

Производственное выполнение относится к конкретному основанию заказа, переходу и использованной инструкции. Новая редакция маршрута не переписывает завершённое. Перевод будущих шагов незавершённой работы на новое основание требует отдельного разрешённого изменения. Нормативное время относится к плану, фактически затраченное — к выполнению; одно не подменяет другое.
