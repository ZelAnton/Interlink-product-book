...
- [Открытые вопросы и риски](../knowledge/12-open-questions-and-risks.md)
- [Сквозные сценарии](13-end-to-end-scenarios.md)

Основания: [IPS-A05], [IPS-A13], [IPS-A23], [IPS-M03], [IL-PLM §4–5], [IL-HOST §8], [IL-ADR ADR-052]. Расшифровка — в [реестре источников](../knowledge/15-source-register.md).
