...
- [Просмотр всех версий](12-all-versions-view.md)

Основания: [IPS-A04], [IPS-K03], [IL-QUERY], [IL-VERS-SPEC]. Расшифровка источников — в [реестре](../knowledge/15-source-register.md).
