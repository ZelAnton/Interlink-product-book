...
- [Конфигуратор](13-configurator-and-presence.md)
- [Точный заказ](16-order-and-snapshot.md)

Основания: [IPS-A04], [IPS-K03], [IL-VERS-SPEC], [IL-ADR]. Расшифровка источников — в [реестре](../knowledge/15-source-register.md).
