...
В режиме анализа остальные ветви можно продолжить показывать. При публикации точного состава наличие хотя бы одной такой позиции останавливает операцию целиком. Нельзя создать «почти полный» производственный снимок и оставить цеху задачу догадаться, чего в нём не хватает.
...
- Если отдельный регулируемый процесс всё же разрешает такой выбор, он должен потребовать явного решения ответственного специалиста и превратить результат в точную фиксацию, а не оставлять его «резервным» навсегда.
...
- [Условия включения позиций](13-configurator-and-presence.md)
- [Точный состав производственного заказа](16-order-and-snapshot.md)

Основания: [IPS-A04], [IPS-K03], [IL-VERS-SPEC §6], [IL-ADR ADR-044, ADR-052]. Расшифровка обозначений источников приведена в [реестре источников](../knowledge/15-source-register.md).
