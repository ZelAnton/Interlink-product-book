...
Основания IPS: [IPS-A05], [IPS-M03]. Современный архитектурный смысл: [IL-KERNEL], [IL-VERS-SPEC], [IL-DATA-MODEL], [IL-PLAN-V2], [IL-SC]. При переносе отдельно проверяются исходные опции, вложенная передача параметров и ограничения конкретной установки IPS. Расшифровка и статус источников приведены в [реестре источников](../knowledge/15-source-register.md).
