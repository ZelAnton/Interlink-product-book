...
- [Последняя версия](07-latest-version-policy.md)
- [Подбор по степени готовности](08-maturity-level-policy.md)
- [Точный состав производственного заказа](16-order-and-snapshot.md)

Основания: [IPS-A02], [IPS-A04], [IPS-K04], [IL-VERS-SPEC]. Расшифровка источников — в [реестре](../knowledge/15-source-register.md).
