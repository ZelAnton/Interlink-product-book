...
Ни один из этих вопросов не заменяет остальные. Отдельно существует различие опубликованного и рабочего содержания версии. Рабочая копия не становится официальной только потому, что у её инженерной версии сохранена высокая степень готовности.
...
## «На этой стадии» и «не ниже этой стадии»

Эти два требования нельзя объединять в одну кнопку. Правило «строго на согласовании» выбирает версии, ожидающие именно этой работы; уже выпущенная версия может не входить в его область. Правило «не ниже проверенной» допускает и проверенную, и более зрелую версию, если внутри выбранной шкалы такой порядок определён.

Например, у насосного вала версия 02 выпущена, а 03 находится на согласовании. Список заданий рецензента должен показать 03 как материал согласования, а не 02 на основании её более высокой готовности. Предварительный расчёт с порогом «не ниже проверенной» может выбирать новейшую допустимую в своей области по другому правилу.

Для архива может быть нужен ещё один режим — показать версии на хранении вместе с их историей. «Хранение» не следует автоматически трактовать ни как запрет чтения, ни как наивысшую готовность для нового изготовления. Требуется подтвердить предметный смысл этой категории в установке IPS.

## Возврат процесса и новое содержание

Возврат чертежа на доработку может изменить права, задания и условия дальнейшего использования. Сохранённая подпись прежнего содержания остаётся историческим свидетельством; она не обязана исчезать из архива из-за нового текущего шага. Но новая публикация исправленных материалов проходит предусмотренные проверки и при необходимости новое согласование.

Когда исправленная отливка версии 09 из примера выше успешно завершит испытания и будет допущена, правило последней выпущенной версии сможет выбрать её. До этого нельзя считать выпуск неизбежным лишь потому, что работа названа «исправлением дефекта».
...
- [Версии и их содержание](README.md)
- [Именованные итерации и восстановление](22-iterations-and-checkpoints.md)

## Основания и границы источников

Основания: [IPS-A02], [IPS-A04], [IL-KERNEL], [IL-VERS-SPEC], [IL-DATA-MODEL], [IL-PLAN-V2]. Расшифровка и статус источников — в [реестре источников](../knowledge/15-source-register.md).
