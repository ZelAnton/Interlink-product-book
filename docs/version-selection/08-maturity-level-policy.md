...
- [Резервный выбор](11-fallback-and-no-match.md)
- [Назначенная основная версия](06-base-version-current.md)

Основания: [IPS-A02], [IPS-A04], [IL-VERS-SPEC], [IL-ADR]. Расшифровка источников — в [реестре](../knowledge/15-source-register.md).
