...
Interlink создаётся как общее основание для систем, работающих с объектами, их признаками, связями, историей и управляемыми изменениями. Машиностроительная PLM — основная область проверки; полное покрытие обязательных пользовательских сценариев IPS остаётся требованием. При этом инженерные версии, составы и заказы не должны навязываться телефону поставщика, событию перевозки или показанию прибора.
