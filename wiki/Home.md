...
Interlink создаётся как объектное основание для систем управления жизненным циклом изделия (PLM) и инженерных систем (CAx) нового поколения. Проект сохраняет сильные предметные идеи IPS — исходной PLM-платформы, с которой сравнивается Interlink, — но стремится сделать правила работы с данными более явными, проверяемыми и пригодными для высокой автоматизированной нагрузки.
...
Если вы впервые знакомитесь с проектом, откройте [[Маршрут первого знакомства|Start-here]]. Он проведёт по ключевым главам примерно за 20–30 минут.

Чтобы сразу увидеть не только замысел, но и полный путь пользователя, откройте [[Как работает система на основе Interlink|How-system-works]].
