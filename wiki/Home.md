...
Базовая редакция согласована с архитектурой 6 сентября 2026 года; **7 сентября** добавлены элементы, предметные понятия и разделение инструкции, применения и выполнения. Это обновление замысла и плана, не объявление новых готовых функций. Если вы уже читали книгу, начните с [[Что изменилось в архитектурном замысле|Foundation-update]].

Новые подробные главы: [[что объединяет общий адрес элемента|Elements-and-concepts]], [[как инструкция превращается в конкретную работу|Instructions-and-execution]] и [[зачем нужен словарь предметных понятий|Domain-concepts]]. Например, два перехода обработки вала могут использовать одну инструкцию, но сохраняют свои параметры, адреса и результаты фактического выполнения.
