...
Переименование распознаётся отдельно по устойчивой идентичности и явной декларации. Большие изменения в целевом процессе проходят этапы «расширить → перенести → проверить → переключить → удалить старое». Только длительный шаг, специально спроектированный для порций, сможет продолжиться от подтверждённой контрольной точки; базовый договор не обещает возобновление любого шага, общий процент или универсальную кнопку повтора.
...
Семантическая модель миграций, классификация риска, проверка расхождений и защита истории зафиксированы нормативно. Исполняемый планировщик миграций, импортёр IPS и промышленный инструментарий сверки остаются будущими возможностями. Описанный процесс является целевым регламентом первой миграции.
