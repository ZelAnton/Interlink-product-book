...
В целевом сценарии принимающее приложение снижает фоновую параллельность и отдаёт приоритет интерактивной работе. Interlink ограничивает поддерживаемые операции: размер чтения, разветвлённость обходов, время работы и объём выдачи. Остановка длинного анализа оставляет честный частичный результат.
...
Честное сравнение требует одинаковой предметной задачи, объёма данных, оборудования, прав доступа, полноты и сохранности. Нельзя сравнить полный доказательный анализ в одной системе с неполной быстрой выборкой в другой и назвать разницу свойством архитектуры.
