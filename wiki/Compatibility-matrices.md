...
[Понятия и их сопоставления](Domain-concepts) полезны для поиска кандидатов: например, найти инструкции или изделия с разными принятыми названиями. Они не доказывают допуск оборудования, взаимозаменяемость уплотнений или совместимость комплекта управления.

Для положительного решения нужны собственные условия и свидетельства совместимости. Если правило использует значение понятия, оно удерживает точный использованный смысл и существенные связи. Правка словаря не пересчитывает старое одобрение и не разрешает новую комбинацию задним числом. [Общий адрес элемента](Elements-and-concepts) не ослабляет эти предметные требования.
