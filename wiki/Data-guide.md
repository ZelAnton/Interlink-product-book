...
- будущие физические таблицы, ограничения целостности и индексы, создаваемые из этой модели;
...
На 1 сентября 2026 года в основной версии реализованы чтение и проверка языка модели, нормализация, устойчивый отпечаток, объединение модулей и манифест поставки. Реализована и часть типизированных прикладных представлений: идентификаторы и записи, связи и преобразование строк результата в предметные записи. Эти преобразователи ещё не создают таблицы базы. Поставка генератора через командную строку и эталонный сквозной пример ещё не прошли итоговую приёмку. Генератор физических таблиц PostgreSQL, планировщик и установщик миграций, команды записи, исполнитель запросов, рабочие расширения и нагрузочное подтверждение остаются будущими возможностями.
