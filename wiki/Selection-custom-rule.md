...
Раньше публичный текст утверждал, что общий смысл любого правила можно изменить только выпуском всей модели предприятия. Это слишком жёсткое ограничение и не покрывает привычный каталог правил IPS.
