...
Сейчас подтверждены язык, проверка и нормализация модели, композиция модулей и часть типизированных прикладных представлений. Физическая материализация, миграции, запись, запросы и эксплуатационные расширения ниже являются целевыми возможностями.
...
Язык модели, его компилятор, устойчивые идентификаторы, наследование, большая часть типов атрибутов, модули и часть типизированных прикладных представлений уже реализованы либо закреплены контрактом. Полная физическая материализация, миграции, эксплуатационные расширения и нагрузочное доказательство остаются будущими возможностями.
