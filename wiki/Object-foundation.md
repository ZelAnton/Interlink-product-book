...
Три новые главы дополняют общий фундамент: [элементы и их адреса](Elements-and-concepts), [инструкция, применение и выполнение](Instructions-and-execution), [предметные понятия и классификация](Domain-concepts). Они объясняют принятый план; готовность новых сценариев ещё предстоит доказать. Объектный фундамент ниже сохраняется — новое слово не переименовывает все объекты в сущности.
