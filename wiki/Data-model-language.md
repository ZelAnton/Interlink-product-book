...
Разделение [типа, инструкции и применения](Instructions-and-execution) снимает необходимость описывать каждый новый маршрут как новый структурный тип. Если установленная форма уже допускает инструмент, режим и поверхность, технолог создаёт инструкцию и её применения как данные. Если новое требование невозможно выразить в разрешённой форме, требуется изменение модели с проверкой последствий.
