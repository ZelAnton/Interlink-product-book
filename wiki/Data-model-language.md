...
В целевом процессе после рецензирования новая версия модели должна будет породить таблицу и прикладные контракты одним согласованным выпуском. Генератора физической схемы и исполнителя установки пока нет.
...
Разбор, связывание, нормализация, отпечаток, модули и манифест реализованы. Реализована и часть типизированных прикладных представлений: идентификаторы и записи, связи и преобразование строк результата в предметные записи. Поставка генератора через командную строку и эталонный сквозной пример ещё не прошли итоговую приёмку. Генератор таблиц PostgreSQL, планировщик и установщик миграций, средство записи и исполнитель запросов остаются будущими возможностями.
