...
| Версии | Выбор по контексту, зрелости и рабочим предпочтениям | Единый объяснимый механизм | Частичная основа; полный пользовательский сценарий ещё не принят |
...
8. Подключить ERP/MES со сверкой неизвестного исхода и возвратом фактов; защиту от дублей включать только по явному договору внешней системы.
...
На 31 августа 2026 года документы описывают целевой контур и основание для реализации. Базовые понятия Interlink уже сформированы, но многоуровневый заказ, конфигуратор, ПВ, производственный слой, внешние передачи и пользовательская приёмка всего заказного пути ещё не являются готовыми функциями.
