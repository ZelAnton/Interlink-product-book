...
Принято [различать повторно используемую инструкцию, её применение и фактическую работу](Instructions-and-execution). В операции точения вала два перехода могут пользоваться одной инструкцией, но иметь разные поверхности, размеры и нормы. Они не сливаются по совпадению инструкции; перестановка сохраняет их устойчивые адреса внутри маршрута.
