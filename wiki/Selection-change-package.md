...
4. удаляет все временные предпочтения: постоянный выбор заранее оформляется отдельной точной фиксацией, а разовое решение заказа — только в новом снимке конкретной передачи;
