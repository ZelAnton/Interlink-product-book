...
Нагрузочные объёмы и критерии зафиксированы в плане. В основной версии реализована часть типизированных прикладных представлений, но она ещё не создаёт таблицы и не выполняет запросы. Физическое исполнение запросов, кэш, команды, снимки и сам нагрузочный прогон остаются будущими возможностями. Утверждение о более высокой нагрузке пока является сильной архитектурной гипотезой, а не опубликованным результатом испытаний.
