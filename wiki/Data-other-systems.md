...
<a id="честные-границы"></a>

## Границы сравнения и подтверждённой готовности
...
- [[Табличные данные|Tabular-data]] и [[матрицы совместимости|Compatibility-matrices]]
- [[Предметные сценарии за пределами машиностроения|Multidomain-scenarios]]
