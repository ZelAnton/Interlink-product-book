...
[Элементы и понятия](Elements-and-concepts) позволяют точнее связывать определения и предметные данные, но не меняют приоритеты жёсткой и мягкой конкретизации, контекстов и остальных правил. Понятие «подходящий подшипник» не является новым источником автоматического резерва.
